...
class DedeTemplate
{
    ...
    {
        //echo __LINE__.'writecache333<br />';
        //echo $this->cacheFile.'<br/>';
        //var_dump(!file_exists($this->cacheFile));
       // var_dump( file_exists($this->templateFile));
       ...
       // echo $this->cacheFile.'<br/>';
        ...
        {
            //echo __LINE__.'666writecache666<br />';
                if(!$this->isParse)
                {
                    echo __LINE__.'writecache<br />';
                    $this->ParseTemplate();
                }
