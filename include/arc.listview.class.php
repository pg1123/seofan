...
class ListView
{
    ...
    function __construct($typeid, $uppage=1)
    {
        ...
        //echo __LINE__.'gou zao<br/>';
        if(!is_array($this->TypeLink->TypeInfos))
        {
            //echo __LINE__.'if typelink->typeinfos<br/>';
            $this->IsError = true;
        }
        if(!$this->IsError)
        {
            //echo __LINE__.'if !iserror!<br/>';
            $this->ChannelUnit = new ChannelUnit($this->TypeLink->TypeInfos['channeltype']);
            //echo __LINE__.' new <br/>';
